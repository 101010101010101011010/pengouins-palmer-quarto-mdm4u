...
### Quelle île héberge le plus de pingouins, et quels et la relation entre les espèces et l'île?
...
En omettant les valeurs lorsque le sexe ou le poids sont nulles, il est d'abord évident, dans la @fig-violin-masscats, que les mâles sont, en moyenne, plus pesants que les femelles. Ceci est le cas pour les trois espèces analysés.
...
Les \adelie{}s et \chinstrap{}s sont ensuite similaires en terme de masse. Les \gentoo{}s, quants à eux, pèsent considérablement plus à `{r} round(penguin_mass_avgs[penguin_mass_avgs$species == "Gentoo",]$mean / penguin_mass_avgs[penguin_mass_avgs$species == "Adelie",]$mean, 2)` fois la masse des \adelie{}s et `{r} round(penguin_mass_avgs[penguin_mass_avgs$species == "Gentoo",]$mean / penguin_mass_avgs[penguin_mass_avgs$species == "Chinstrap",]$mean, 2)` fois la masse des \chinstrap{}s.
