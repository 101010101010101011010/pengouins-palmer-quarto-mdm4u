...
#| exho: FALSE
#| tbl-cap: "Les pingouins aberrantes, soit hors des bornes indiquées par le [Tableau @tbl-aberrantes-minmax], en groupant par espèce et par sélectionnant lorsque la variable `Longueure de la nageoire (mm)` abèrre. Les cellules ayant un arrière-plan noir et du texte blanc indiquent une valeur aberrante."
#| out-width: '100%'
#| tbl-align: 'center'
